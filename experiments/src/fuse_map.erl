...
-define(UFM_INTERCONNECTS(),
    ...
    ?UFM_INTERCONNECT(23, 3, direct_link);
...
-define(LAB_CELLS(),
    ?LAB_CELL(2, 0, 0, {{interconnect, 5}, from4, mux2});
    ?LAB_CELL(2, 0, 1, {{interconnect, 5}, from4, mux3});
    ?LAB_CELL(2, 0, 2, {{interconnect, 6}, from4, mux2});
    ?LAB_CELL(2, 0, 3, {{interconnect, 6}, from4, mux3});
    ?LAB_CELL(2, 1, 0, {{interconnect, 7}, from4, mux2});
    ?LAB_CELL(2, 1, 1, {{interconnect, 7}, from4, mux3});
    ?LAB_CELL(2, 1, 2, {{interconnect, 8}, from4, mux2});
    ?LAB_CELL(2, 1, 3, {{interconnect, 8}, from4, mux3});
    ?LAB_CELL(2, 2, 0, {{interconnect, 9}, from4, mux2});
    ?LAB_CELL(2, 2, 1, {{interconnect, 9}, from4, mux3});
    ?LAB_CELL(2, 2, 2, {{interconnect,10}, from4, mux2});
    ?LAB_CELL(2, 2, 3, {{interconnect,10}, from4, mux3});
    ?LAB_CELL(2, 3, 0, {{interconnect,11}, from4, mux2});
    ?LAB_CELL(2, 3, 1, {{interconnect,11}, from4, mux3});
    ?LAB_CELL(2, 3, 2, {{interconnect,12}, from4, mux2});
    ?LAB_CELL(2, 3, 3, {{interconnect,12}, from4, mux3});
    ?LAB_CELL(2, 5, 0, {{interconnect,18}, from4, mux2});
    ?LAB_CELL(2, 5, 1, {{interconnect,18}, from4, mux3});
    ?LAB_CELL(2, 5, 2, {{interconnect,19}, from4, mux2});
    ?LAB_CELL(2, 5, 3, {{interconnect,19}, from4, mux3});
    ?LAB_CELL(2, 6, 0, {{interconnect,20}, from4, mux2});
    ?LAB_CELL(2, 6, 1, {{interconnect,20}, from4, mux3});
    ?LAB_CELL(2, 6, 2, {{interconnect,21}, from4, mux2});
    ?LAB_CELL(2, 6, 3, {{interconnect,21}, from4, mux3});
    ?LAB_CELL(2, 7, 0, {{interconnect,22}, from4, mux2});
    ?LAB_CELL(2, 7, 1, {{interconnect,22}, from4, mux3});
    ?LAB_CELL(2, 7, 2, {{interconnect,23}, from4, mux2});
    ?LAB_CELL(2, 7, 3, {{interconnect,23}, from4, mux3});
    ?LAB_CELL(2, 8, 0, {{interconnect,24}, from4, mux2});
    ?LAB_CELL(2, 8, 1, {{interconnect,24}, from4, mux3});
    ?LAB_CELL(2, 8, 2, {{interconnect,25}, from4, mux2});
    ?LAB_CELL(2, 8, 3, {{interconnect,25}, from4, mux3});
    ?LAB_CELL(3, 0, 0, {{interconnect, 5}, from4, mux0});
    ?LAB_CELL(3, 0, 1, {{interconnect, 5}, from4, mux1});
    ?LAB_CELL(3, 0, 2, {{interconnect, 6}, from4, mux0});
    ?LAB_CELL(3, 0, 3, {{interconnect, 6}, from4, mux1});
    ?LAB_CELL(3, 1, 0, {{interconnect, 7}, from4, mux0});
    ?LAB_CELL(3, 1, 1, {{interconnect, 7}, from4, mux1});
    ?LAB_CELL(3, 1, 2, {{interconnect, 8}, from4, mux0});
    ?LAB_CELL(3, 1, 3, {{interconnect, 8}, from4, mux1});
    ?LAB_CELL(3, 2, 0, {{interconnect, 9}, from4, mux0});
    ?LAB_CELL(3, 2, 1, {{interconnect, 9}, from4, mux1});
    ?LAB_CELL(3, 2, 2, {{interconnect,10}, from4, mux0});
    ?LAB_CELL(3, 2, 3, {{interconnect,10}, from4, mux1});
    ?LAB_CELL(3, 3, 0, {{interconnect,11}, from4, mux0});
    ?LAB_CELL(3, 3, 1, {{interconnect,11}, from4, mux1});
    ?LAB_CELL(3, 3, 2, {{interconnect,12}, from4, mux0});
    ?LAB_CELL(3, 3, 3, {{interconnect,12}, from4, mux1});
    ?LAB_CELL(3, 4, 2, {clk1, global0});
    ?LAB_CELL(3, 4, 3, {clk1, global1});
    ?LAB_CELL(3, 5, 0, {{interconnect,18}, from4, mux0});
    ?LAB_CELL(3, 5, 1, {{interconnect,18}, from4, mux1});
    ?LAB_CELL(3, 5, 2, {{interconnect,19}, from4, mux0});
    ?LAB_CELL(3, 5, 3, {{interconnect,19}, from4, mux1});
    ?LAB_CELL(3, 6, 0, {{interconnect,20}, from4, mux0});
    ?LAB_CELL(3, 6, 1, {{interconnect,20}, from4, mux1});
    ?LAB_CELL(3, 6, 2, {{interconnect,21}, from4, mux0});
    ?LAB_CELL(3, 6, 3, {{interconnect,21}, from4, mux1});
    ?LAB_CELL(3, 7, 0, {{interconnect,22}, from4, mux0});
    ?LAB_CELL(3, 7, 1, {{interconnect,22}, from4, mux1});
    ?LAB_CELL(3, 7, 2, {{interconnect,23}, from4, mux0});
    ?LAB_CELL(3, 7, 3, {{interconnect,23}, from4, mux1});
    ?LAB_CELL(3, 8, 0, {{interconnect,24}, from4, mux0});
    ?LAB_CELL(3, 8, 1, {{interconnect,24}, from4, mux1});
    ?LAB_CELL(3, 8, 2, {{interconnect,25}, from4, mux0});
    ?LAB_CELL(3, 8, 3, {{interconnect,25}, from4, mux1});
    ?LAB_CELL(3, 9, 2, {clk1, global2});
    ?LAB_CELL(3, 9, 3, {clk1, global3});
    ?LAB_CELL(4, 0, 0, {{interconnect, 5}, from3, mux2});
    ?LAB_CELL(4, 0, 1, {{interconnect, 5}, direct_link});
    ?LAB_CELL(4, 0, 2, {{interconnect, 6}, from3, mux2});
    ?LAB_CELL(4, 0, 3, {{interconnect, 6}, direct_link});
    ?LAB_CELL(4, 1, 0, {{interconnect, 7}, from3, mux2});
    ?LAB_CELL(4, 1, 1, {{interconnect, 7}, direct_link});
    ?LAB_CELL(4, 1, 2, {{interconnect, 8}, from3, mux2});
    ?LAB_CELL(4, 1, 3, {{interconnect, 8}, direct_link});
    ?LAB_CELL(4, 2, 0, {{interconnect, 9}, from3, mux2});
    ?LAB_CELL(4, 2, 1, {{interconnect, 9}, direct_link});
    ?LAB_CELL(4, 2, 2, {{interconnect,10}, from3, mux2});
    ?LAB_CELL(4, 2, 3, {{interconnect,10}, direct_link});
    ?LAB_CELL(4, 3, 0, {{interconnect,11}, from3, mux2});
    ?LAB_CELL(4, 3, 1, {{interconnect,11}, direct_link});
    ?LAB_CELL(4, 3, 2, {{interconnect,12}, from3, mux2});
    ...
    ?LAB_CELL(4, 5, 0, {{interconnect,18}, from3, mux2});
    ?LAB_CELL(4, 5, 1, {{interconnect,18}, direct_link});
    ?LAB_CELL(4, 5, 2, {{interconnect,19}, from3, mux2});
    ?LAB_CELL(4, 5, 3, {{interconnect,19}, direct_link});
    ?LAB_CELL(4, 6, 0, {{interconnect,20}, from3, mux2});
    ?LAB_CELL(4, 6, 1, {{interconnect,20}, direct_link});
    ?LAB_CELL(4, 6, 2, {{interconnect,21}, from3, mux2});
    ?LAB_CELL(4, 6, 3, {{interconnect,21}, direct_link});
    ?LAB_CELL(4, 7, 0, {{interconnect,22}, from3, mux2});
    ?LAB_CELL(4, 7, 1, {{interconnect,22}, direct_link});
    ?LAB_CELL(4, 7, 2, {{interconnect,23}, from3, mux2});
    ?LAB_CELL(4, 7, 3, {{interconnect,23}, direct_link});
    ?LAB_CELL(4, 8, 0, {{interconnect,24}, from3, mux2});
    ?LAB_CELL(4, 8, 1, {{interconnect,24}, direct_link});
    ?LAB_CELL(4, 8, 2, {{interconnect,25}, from3, mux2});
    ...
    ?LAB_CELL(5, 0, 0, {{interconnect, 5}, from3, mux0});
    ?LAB_CELL(5, 0, 1, {{interconnect, 5}, from3, mux1});
    ?LAB_CELL(5, 0, 2, {{interconnect, 6}, from3, mux0});
    ?LAB_CELL(5, 0, 3, {{interconnect, 6}, from3, mux1});
    ?LAB_CELL(5, 1, 0, {{interconnect, 7}, from3, mux0});
    ?LAB_CELL(5, 1, 1, {{interconnect, 7}, from3, mux1});
    ?LAB_CELL(5, 1, 2, {{interconnect, 8}, from3, mux0});
    ?LAB_CELL(5, 1, 3, {{interconnect, 8}, from3, mux1});
    ?LAB_CELL(5, 2, 0, {{interconnect, 9}, from3, mux0});
    ?LAB_CELL(5, 2, 1, {{interconnect, 9}, from3, mux1});
    ?LAB_CELL(5, 2, 2, {{interconnect,10}, from3, mux0});
    ?LAB_CELL(5, 2, 3, {{interconnect,10}, from3, mux1});
    ?LAB_CELL(5, 3, 0, {{interconnect,11}, from3, mux0});
    ?LAB_CELL(5, 3, 1, {{interconnect,11}, from3, mux1});
    ?LAB_CELL(5, 3, 2, {{interconnect,12}, from3, mux0});
    ?LAB_CELL(5, 3, 3, {{interconnect,12}, from3, mux1});
    ?LAB_CELL(5, 4, 2, {a_clr, global0});
    ?LAB_CELL(5, 4, 3, {a_clr, global1});
    ?LAB_CELL(5, 5, 0, {{interconnect,18}, from3, mux0});
    ?LAB_CELL(5, 5, 1, {{interconnect,18}, from3, mux1});
    ?LAB_CELL(5, 5, 2, {{interconnect,19}, from3, mux0});
    ?LAB_CELL(5, 5, 3, {{interconnect,19}, from3, mux1});
    ?LAB_CELL(5, 6, 0, {{interconnect,20}, from3, mux0});
    ?LAB_CELL(5, 6, 1, {{interconnect,20}, from3, mux1});
    ?LAB_CELL(5, 6, 2, {{interconnect,21}, from3, mux0});
    ?LAB_CELL(5, 6, 3, {{interconnect,21}, from3, mux1});
    ?LAB_CELL(5, 7, 0, {{interconnect,22}, from3, mux0});
    ?LAB_CELL(5, 7, 1, {{interconnect,22}, from3, mux1});
    ?LAB_CELL(5, 7, 2, {{interconnect,23}, from3, mux0});
    ?LAB_CELL(5, 7, 3, {{interconnect,23}, from3, mux1});
    ?LAB_CELL(5, 8, 0, {{interconnect,24}, from3, mux0});
    ?LAB_CELL(5, 8, 1, {{interconnect,24}, from3, mux1});
    ?LAB_CELL(5, 8, 2, {{interconnect,25}, from3, mux0});
    ?LAB_CELL(5, 8, 3, {{interconnect,25}, from3, mux1});
    ?LAB_CELL(5, 9, 2, {a_clr, global2});
    ?LAB_CELL(5, 9, 3, {a_clr, global3});
    ?LAB_CELL(22, 0, 2, {{interconnect, 0}, from3, mux0});
    ?LAB_CELL(22, 0, 3, {{interconnect, 0}, from3, mux1});
    ?LAB_CELL(22, 1, 2, {{interconnect, 1}, from3, mux0});
    ?LAB_CELL(22, 1, 3, {{interconnect, 1}, from3, mux1});
    ?LAB_CELL(22, 2, 2, {{interconnect, 2}, from3, mux0});
    ?LAB_CELL(22, 2, 3, {{interconnect, 2}, from3, mux1});
    ?LAB_CELL(22, 3, 2, {{interconnect, 3}, from3, mux0});
    ?LAB_CELL(22, 3, 3, {{interconnect, 3}, from3, mux1});
    ?LAB_CELL(22, 4, 2, {{interconnect, 4}, from3, mux0});
    ?LAB_CELL(22, 4, 3, {{interconnect, 4}, from3, mux1});
    ?LAB_CELL(22, 5, 2, {{interconnect,13}, from3, mux0});
    ?LAB_CELL(22, 5, 3, {{interconnect,13}, from3, mux1});
    ?LAB_CELL(22, 6, 2, {{interconnect,14}, from3, mux0});
    ?LAB_CELL(22, 6, 3, {{interconnect,14}, from3, mux1});
    ?LAB_CELL(22, 7, 2, {{interconnect,15}, from3, mux0});
    ?LAB_CELL(22, 7, 3, {{interconnect,15}, from3, mux1});
    ?LAB_CELL(22, 8, 2, {{interconnect,16}, from3, mux0});
    ?LAB_CELL(22, 8, 3, {{interconnect,16}, from3, mux1});
    ?LAB_CELL(22, 9, 2, {{interconnect,17}, from3, mux0});
    ?LAB_CELL(22, 9, 3, {{interconnect,17}, from3, mux1});
    ?LAB_CELL(23, 0, 2, {{interconnect, 0}, from3, mux2});
    ?LAB_CELL(23, 0, 3, {{interconnect, 0}, direct_link});
    ?LAB_CELL(23, 1, 2, {{interconnect, 1}, from3, mux2});
    ?LAB_CELL(23, 1, 3, {{interconnect, 1}, direct_link});
    ?LAB_CELL(23, 2, 2, {{interconnect, 2}, from3, mux2});
    ?LAB_CELL(23, 2, 3, {{interconnect, 2}, direct_link});
    ?LAB_CELL(23, 3, 2, {{interconnect, 3}, from3, mux2});
    ?LAB_CELL(23, 3, 3, {{interconnect, 3}, direct_link});
    ?LAB_CELL(23, 4, 2, {{interconnect, 4}, from3, mux2});
    ?LAB_CELL(23, 4, 3, {{interconnect, 4}, direct_link});
    ?LAB_CELL(23, 5, 2, {{interconnect,13}, from3, mux2});
    ?LAB_CELL(23, 5, 3, {{interconnect,13}, direct_link});
    ?LAB_CELL(23, 6, 2, {{interconnect,14}, from3, mux2});
    ?LAB_CELL(23, 6, 3, {{interconnect,14}, direct_link});
    ?LAB_CELL(23, 7, 2, {{interconnect,15}, from3, mux2});
    ?LAB_CELL(23, 7, 3, {{interconnect,15}, direct_link});
    ?LAB_CELL(23, 8, 2, {{interconnect,16}, from3, mux2});
    ?LAB_CELL(23, 8, 3, {{interconnect,16}, direct_link});
    ?LAB_CELL(23, 9, 2, {{interconnect,17}, from3, mux2});
    ?LAB_CELL(23, 9, 3, {{interconnect,17}, direct_link});
    ?LAB_CELL(24, 0, 2, {{interconnect, 0}, from4, mux0});
    ?LAB_CELL(24, 0, 3, {{interconnect, 0}, from4, mux1});
    ?LAB_CELL(24, 1, 2, {{interconnect, 1}, from4, mux0});
    ?LAB_CELL(24, 1, 3, {{interconnect, 1}, from4, mux1});
    ?LAB_CELL(24, 2, 2, {{interconnect, 2}, from4, mux0});
    ?LAB_CELL(24, 2, 3, {{interconnect, 2}, from4, mux1});
    ?LAB_CELL(24, 3, 2, {{interconnect, 3}, from4, mux0});
    ?LAB_CELL(24, 3, 3, {{interconnect, 3}, from4, mux1});
    ?LAB_CELL(24, 4, 2, {{interconnect, 4}, from4, mux0});
    ?LAB_CELL(24, 4, 3, {{interconnect, 4}, from4, mux1});
    ?LAB_CELL(24, 5, 2, {{interconnect,13}, from4, mux0});
    ?LAB_CELL(24, 5, 3, {{interconnect,13}, from4, mux1});
    ?LAB_CELL(24, 6, 2, {{interconnect,14}, from4, mux0});
    ?LAB_CELL(24, 6, 3, {{interconnect,14}, from4, mux1});
    ?LAB_CELL(24, 7, 2, {{interconnect,15}, from4, mux0});
    ?LAB_CELL(24, 7, 3, {{interconnect,15}, from4, mux1});
    ?LAB_CELL(24, 8, 2, {{interconnect,16}, from4, mux0});
    ?LAB_CELL(24, 8, 3, {{interconnect,16}, from4, mux1});
    ?LAB_CELL(24, 9, 2, {{interconnect,17}, from4, mux0});
    ?LAB_CELL(24, 9, 3, {{interconnect,17}, from4, mux1});
    ?LAB_CELL(25, 0, 2, {{interconnect, 0}, from4, mux2});
    ?LAB_CELL(25, 0, 3, {{interconnect, 0}, from4, mux3});
    ?LAB_CELL(25, 1, 2, {{interconnect, 1}, from4, mux2});
    ?LAB_CELL(25, 1, 3, {{interconnect, 1}, from4, mux3});
    ?LAB_CELL(25, 2, 2, {{interconnect, 2}, from4, mux2});
    ?LAB_CELL(25, 2, 3, {{interconnect, 2}, from4, mux3});
    ?LAB_CELL(25, 3, 2, {{interconnect, 3}, from4, mux2});
    ?LAB_CELL(25, 3, 3, {{interconnect, 3}, from4, mux3});
    ?LAB_CELL(25, 4, 2, {{interconnect, 4}, from4, mux2});
    ?LAB_CELL(25, 4, 3, {{interconnect, 4}, from4, mux3});
    ?LAB_CELL(25, 5, 2, {{interconnect,13}, from4, mux2});
    ?LAB_CELL(25, 5, 3, {{interconnect,13}, from4, mux3});
    ?LAB_CELL(25, 6, 2, {{interconnect,14}, from4, mux2});
    ?LAB_CELL(25, 6, 3, {{interconnect,14}, from4, mux3});
    ?LAB_CELL(25, 7, 2, {{interconnect,15}, from4, mux2});
    ?LAB_CELL(25, 7, 3, {{interconnect,15}, from4, mux3});
    ?LAB_CELL(25, 8, 2, {{interconnect,16}, from4, mux2});
    ?LAB_CELL(25, 8, 3, {{interconnect,16}, from4, mux3});
    ?LAB_CELL(25, 9, 2, {{interconnect,17}, from4, mux2});
    ?LAB_CELL(25, 9, 3, {{interconnect,17}, from4, mux3});
).
...
-define(LAB_LINES(),
    ...
    ?LAB_LINE( 6, 21, {{control, 0}, from6, mux2});
    ?LAB_LINE( 6, 22, {{control, 2}, from6, mux0});
    ?LAB_LINE( 6, 23, {{control, 2}, from6, mux2});
    ?LAB_LINE( 6, 24, {{control, 4}, from6, mux0});
    ?LAB_LINE( 6, 25, {{control, 4}, from6, mux2});
    ?LAB_LINE( 7, 20, {{control, 0}, from6, mux3});
    ?LAB_LINE( 7, 21, {{control, 0}, from6, mux5});
    ?LAB_LINE( 7, 22, {{control, 2}, from6, mux3});
    ?LAB_LINE( 7, 23, {{control, 2}, from6, mux5});
    ?LAB_LINE( 7, 24, {{control, 4}, from6, mux3});
    ?LAB_LINE( 7, 25, {{control, 4}, from6, mux5});
    ?LAB_LINE( 8, 20, {{control, 0}, from6, mux1});
    ?LAB_LINE( 8, 21, {{control, 0}, from6, mux4});
    ?LAB_LINE( 8, 22, {{control, 2}, from6, mux1});
    ?LAB_LINE( 8, 23, {{control, 2}, from6, mux4});
    ?LAB_LINE( 8, 24, {{control, 4}, from6, mux1});
    ?LAB_LINE( 8, 25, {{control, 4}, from6, mux4});
    ?LAB_LINE( 9, 20, {{control, 1}, from6, mux1});
    ?LAB_LINE( 9, 21, {{control, 1}, from6, mux2});
    ?LAB_LINE( 9, 22, {{control, 3}, from6, mux1});
    ?LAB_LINE( 9, 23, {{control, 3}, from6, mux2});
    ?LAB_LINE( 9, 24, {{control, 5}, from6, mux1});
    ?LAB_LINE( 9, 25, {{control, 5}, from6, mux2});
    ?LAB_LINE(10, 20, {{control, 1}, from6, mux3});
    ?LAB_LINE(10, 21, {{control, 1}, from6, mux5});
    ?LAB_LINE(10, 22, {{control, 3}, from6, mux3});
    ?LAB_LINE(10, 23, {{control, 3}, from6, mux5});
    ?LAB_LINE(10, 24, {{control, 5}, from6, mux3});
    ?LAB_LINE(10, 25, {{control, 5}, from6, mux5});
    ?LAB_LINE(11, 20, {{control, 1}, from6, mux0});
    ?LAB_LINE(11, 21, {{control, 1}, from6, mux4});
    ?LAB_LINE(11, 22, {{control, 3}, from6, mux0});
    ?LAB_LINE(11, 23, {{control, 3}, from6, mux4});
    ?LAB_LINE(11, 24, {{control, 5}, from6, mux0});
    ?LAB_LINE(11, 25, {{control, 5}, from6, mux4});
    ?LAB_LINE(12, 20, {{control, 0}, from3, mux0});
    ?LAB_LINE(12, 21, {{control, 1}, from3, mux2});
    ?LAB_LINE(12, 22, {{control, 2}, from3, mux0});
    ?LAB_LINE(12, 23, {{control, 3}, from3, mux2});
    ?LAB_LINE(12, 24, {{control, 4}, from3, mux0});
    ?LAB_LINE(12, 25, {{control, 5}, from3, mux2});
    ...
    ?LAB_LINE(14, 21, {{control, 1}, from3, mux0});
    ?LAB_LINE(14, 22, {{control, 2}, from3, mux2});
    ?LAB_LINE(14, 23, {{control, 3}, from3, mux0});
    ?LAB_LINE(14, 24, {{control, 4}, from3, mux2});
    ?LAB_LINE(14, 25, {{control, 5}, from3, mux0});
...
-define(LC_CELLS(),
    ...
    ?LC_CELL( 6, 1, {data_a6, mux2});
    ?LC_CELL( 6, 2, {data_c6, mux0});
    ?LC_CELL( 6, 3, {data_c6, mux2});
    ?LC_CELL( 7, 0, {data_a6, mux3});
    ?LC_CELL( 7, 1, {data_a6, mux5});
    ?LC_CELL( 7, 2, {data_c6, mux3});
    ?LC_CELL( 7, 3, {data_c6, mux5});
    ?LC_CELL( 8, 0, {data_b6, mux0});
    ?LC_CELL( 8, 1, {data_b6, mux4});
    ?LC_CELL( 8, 2, {data_c6, mux1});
    ?LC_CELL( 8, 3, {data_c6, mux4});
    ?LC_CELL( 9, 0, {data_b6, mux1});
    ?LC_CELL( 9, 1, {data_b6, mux2});
    ?LC_CELL( 9, 2, {data_d6, mux1});
    ?LC_CELL( 9, 3, {data_d6, mux2});
    ?LC_CELL(10, 0, {data_b6, mux3});
    ?LC_CELL(10, 1, {data_b6, mux5});
    ?LC_CELL(10, 2, {data_d6, mux3});
    ?LC_CELL(10, 3, {data_d6, mux5});
    ?LC_CELL(11, 0, {data_a6, mux1});
    ?LC_CELL(11, 1, {data_a6, mux4});
    ?LC_CELL(11, 2, {data_d6, mux0});
    ?LC_CELL(11, 3, {data_d6, mux4});
    ?LC_CELL(12, 0, {data_a3, mux0});
    ?LC_CELL(12, 1, {data_b3, mux2});
    ?LC_CELL(12, 2, {data_c3, mux0});
    ?LC_CELL(12, 3, {data_d3, mux2});
    ...
    ?LC_CELL(14, 1, {data_b3, mux0});
    ?LC_CELL(14, 2, {data_c3, mux2});
    ?LC_CELL(14, 3, {data_d3, mux0});
...
from_density({{global, X, Y}, N, Name}, With = #with{}) ->
    case from_density_global(X, Y, N, With) of
        ok ->
            from_global_select(N, Name, With);
...
from_density({{jtag, X, Y}, Name, Value}, With = #with{}) ->
    from_jtag(X, Y, {Name, Value}, With);
...
from_density({{ufm, X, Y}, Name, Value}, With = #with{}) ->
    from_ufm(X, Y, Name, Value, With);
...
-define(IOB_SIDE(Sector, N, Index, Name, Value),
    from_iob_side(X, Y, Name, Value, With) ->
        from_side(X, Sector, Y, N, Index, With)
).
-define(IOB_LEFT_LINE(Sector, Index, Name, Value),
    from_iob_side(X, Y, Name, Value, With) when X =:= With#with.left_x ->
        from_line(X, Sector, Y, Index, With)
).
-define(IOB_RIGHT_LINE(Sector, Index, Name, Value),
    from_iob_side(X, Y, Name, Value, With) when X =:= With#with.right_x ->
        from_line(X, Sector, Y, Index, With)
).
...
?IOB_LEFT_LINES()
?IOB_RIGHT_LINES()
from_iob_side(X, Y, Name, Value, _With) ->
    {error, {iob_side, X, Y, Name, Value}}.
...
-define(IOB_HEAD(Sector, Index, Name, Value),
    from_iob(X, Y, Name, Value, With = #with{top_y = Y}) ->
        from_head(X, Sector, Index, With);
    from_iob(X, Y, Name, Value, With = #with{short_y = Y})
            when X < With#with.grow_x ->
        from_tail(X, Sector, Index, With, With#with.short_lines);
    from_iob(X, Y, Name, Value, With = #with{long_y = Y})
            when X > With#with.grow_x ->
        from_tail(X, Sector, Index, With, With#with.long_lines)
).
-define(UFM_INTERCONNECT(Sector, Index, Value),
    from_iob(X, Y, {interconnect, N}, Value, With = #with{grow_x = X, short_y = 3})
            when Y =:= 2 orelse Y =:= 3 ->
...
?IOB_HEADS()
?UFM_INTERCONNECTS()
from_iob(X, Y, Name, Value, _With) ->
    {error, {{iob, X, Y}, Name, Value}}.
...
-define(JTAG_LARGE_SELECT(Y, N, U),
    ...
    from_jtag(X, Y, {U, DirectLink}, With = #with{grow_x = X}) ->
        from_ufm_select(X, Y, N, DirectLink, With)
).
...
-define(UFM_INTERCONNECT(Sector, Index, Name),
    from_ufm(X, Y, {interconnect, N}, Name, With = #with{grow_x = X})
            when Y =:= 2 orelse Y =:= 3 ->
        from_cell(X, Sector, Y, N, Index, With)
).
-define(UFM_SMALL_INVERT(Y, N, FromN, U),
    from_ufm(X, Y, U, invert, With = #with{density = max_v_240z}) ->
...
-define(UFM_LARGE_SELECT(Y, N, U),
    from_ufm(X, Y, U, Value, With = #with{grow_x = X}) ->
        from_ufm_select(X, Y, N, Value, With)
).

?UFM_INTERCONNECTS()
?UFM_SMALL_SELECTS()
?UFM_LARGE_SELECTS()
from_ufm(X, Y, Name, Value, _With) ->
    {error, {{invalid_ufm, X, Y}, Name, Value}}.
...
-define(UFM_SELECT(Sector, Index, Name),
    from_ufm_select(X, Y, N, Name, With) ->
        from_cell(X, Sector, Y, N, Index, With)
).

?UFM_SELECTS()
from_ufm_select(X, Y, N, Name, _With) ->
    {error, {{invalid_ufm_select, X, Y}, N, Name}}.
...
-define(IOB_HEAD(Sector, Index, Name, Value),
    to_cell_head(X, Index, Sector, With) ->
        to_iob(X, With#with.top_y, Name, Value)
).
-define(IOC_HEAD(Sector, Index, N, Name),
    to_cell_head(X, Index, Sector, With) ->
...
-define(IOB_HEAD(Sector, Index, Name, Value),
    to_cell_tail(X, Index, Sector, With) when X < With#with.grow_x ->
        to_iob(X, With#with.short_y, Name, Value);
    to_cell_tail(X, Index, Sector, With) when X > With#with.grow_x ->
        to_iob(X, With#with.long_y, Name, Value)
).
-define(IOC_HEAD(Sector, Index, N, Name),
    to_cell_tail(X, Index, Sector, With) when X < With#with.grow_x ->
...
-define(UFM_INTERCONNECT(Sector, Index, Name),
    to_cell(X, Y, N, Index, Sector, #with{grow_x = X, short_y = 3})
            when Y =:= 2 orelse Y =:= 3 ->
        to_ufm(X, Y, {interconnect, N}, Name)
).
-define(UFM_SELECT(Sector, Index, Name),
    to_cell(X, Y, N, Index, Sector, #with{grow_x = X, short_y = 3})
            when Y =:= 2 orelse Y =:= 3 ->
        to_ufm_select(X, Y, N, Name)
).
-define(LAB_CELL(Sector, N, I, Name),
    to_cell(X, Y, N, I, Sector, _) ->
        to_lab(X, Y, Name)
...
to_ufm(X, Y, Name, Value) ->
    {ok, {{ufm, X, Y}, Name, Value}}.
...
-define(GLOBAL_LARGE_SELECT(Y, N, G),
    ...
    to_ufm_select(X, Y, N, DirectLink) ->
        {ok, {{global, X, Y}, G, DirectLink}}
).
-define(JTAG_LARGE_SELECT(Y, N, J),
    to_ufm_select(X, Y, N, {Key, Value}) ->
        {ok, {{jtag, X, Y}, J, Key, Value}};
    to_ufm_select(X, Y, N, DirectLink) ->
        {ok, {{jtag, X, Y}, J, DirectLink}}
).
-define(UFM_LARGE_SELECT(Y, N, U),
    to_ufm_select(X, Y, N, {Key, Value}) ->
        {ok, {{ufm, X, Y}, U, Key, Value}};
    to_ufm_select(X, Y, N, DirectLink) ->
        {ok, {{ufm, X, Y}, U, DirectLink}}
).
